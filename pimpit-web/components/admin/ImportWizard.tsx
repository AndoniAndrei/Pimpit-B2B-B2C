            ...
            <div className="md:col-span-2">
              ...
              <div className="flex gap-1 mb-3 bg-muted rounded-lg p-1 w-fit">
                <button type="button"
                  ...
                  className={`px-4 py-1.5 rounded-md text-sm font-medium transition-colors ${!uploadMode ? 'bg-card shadow text-foreground' : 'text-muted-foreground hover:text-foreground'}`}>
                  URL feed
                </button>
                <button type="button"
              ...
              {!uploadMode ? (<>
                ...
                <div className={`border-2 border-dashed rounded-lg px-4 py-6 text-center cursor-pointer transition-colors ${uploadedFile ? 'border-primary/40 bg-primary/5' : 'border-border hover:border-primary/40'}`}
                      ...
                      <div className="space-y-1.5">
                        ...
                        {openPickerFor === field.key && (
                          <div className="flex flex-wrap gap-1.5 p-3 bg-muted/50 rounded-lg border">
                            {columns.map(col => (
                              <button key={col} type="button"
                                className="text-xs bg-card hover:bg-primary hover:text-primary-foreground border px-2 py-1 rounded-md font-mono transition-colors"
            ...
            <div className="mt-8 pt-6 border-t">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {/* Brand picker panel */}
                  {brandPickerOpen && (
                    <div className="mt-3 border rounded-xl p-4 bg-muted space-y-3">
                        ...
                        <>
                          ...
                          <div className="max-h-52 overflow-y-auto space-y-1 pr-1">
                            {brandScanList.map(brand => (
                              <label key={brand} className="flex items-center gap-2.5 cursor-pointer hover:bg-card rounded px-1 py-0.5">
                                <input type="checkbox"
                          ...
                          <div className="flex gap-2 pt-1 border-t">
                            ...
                            <button type="button" onClick={() => setBrandPickerOpen(false)}
                              className="px-4 border rounded-lg text-sm hover:bg-muted">
                              Anulează
                            </button>
                          </div>
                        </>
              ...
              {importResult.ok ? (
                <div className="text-green-800">
                  ...
                  <div className="mt-3 flex gap-3">
                    ...
                    <a href="/admin/importuri" className="inline-block border px-4 py-2 rounded-lg text-sm font-medium hover:bg-card/50">
                      Înapoi la importuri
                    </a>
                  </div>
                </div>
